...
import org.finalbi.commands.DMMANGER;
import org.finalbi.commands.DevCommands;
import org.finalbi.commands.EvalCommands;
import org.finalbi.commands.GameCommands;
...
public class Main {
    ...
    public static void main(String[] args) throws LoginException {
        ...
        jda.upsertCommand("devmode", "for dev only allows accsess to special commands").queue();
        jda.upsertCommand("shutdown", "shuts the bot down ").queue();
